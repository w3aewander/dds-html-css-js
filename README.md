...
4. Configurar o composer: baixar o **composer.phar** ou utilizar o [link do composer](https://getcomposer.org/download/ "composer") oferido no site oficial para o download correto da aplicação de acordo com a versão do PHP instalado;
